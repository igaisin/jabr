...
impl AccessibleTextAttributes {
     ...
     * `info` - информация о текстовых атрибутах.
     * 
     * Этот метод создает новый экземпляр структуры `AccessibleTextAttributes` на основе
     * предоставленной информации о текстовых атрибутах. Он преобразует значения из `info`
